...
INPUT_MAP="${INPUT_MAP:-maps/gk/grid_map_gk.map}"
NODES_FILE="${NODES_FILE:-maps/gk/grid_map_gk.nodes.txt}"
TASKS_FILE="${TASKS_FILE:-maps/gk/Tasks_gk.txt}"
RHCR_MAP="${RHCR_MAP:-maps/gk/grid_map_gk.rhcr.map}"
RHCR_TASKS="${RHCR_TASKS:-maps/gk/grid_map_gk.rhcr.tasks.txt}"
DECODED_TASKS="${DECODED_TASKS:-/tmp/rhcr_grid_map_gk_decoded_tasks.txt}"
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/rhcr_grid_map_gk_run}"
GIF_FILE="${GIF_FILE:-/tmp/rhcr_grid_map_gk_run.gif}"
...
BREAKDOWN_AGENT="${BREAKDOWN_AGENT:-0}"
BREAKDOWN_AFTER_TASKS="${BREAKDOWN_AFTER_TASKS:-0}"
BREAKDOWN_LOCATION="${BREAKDOWN_LOCATION:-574}"
DUMMY_PATHS=0
HOLD_ENDPOINTS=0
FPS="${FPS:-30}"
